...
public class JWTUtils {
     ...
     * 过期时间5秒
     */
    private static final long EXPIRE_TIME = 10000 * 5;
     ...
     * @return
     */
    public static String vaildToken(String token ) throws ResultException{
        try {
            ...
            e.printStackTrace();
            throw ResultException.of(-4, "token校验错误");
